...
#define kBehavioralRespectStrings @"Student uses kind words and actions,, Student respects other people’s property,, Student has friends and engages in appropriate behaviors with friends"
